    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!token)
                    return [2 /*return*/, next(new appError_1.default("No token found", 404))];
                decodedToken = (0, verifyToken_1.default)(token);
                return [4 /*yield*/, user_model_1.default.findById(decodedToken.userId)];
            case 1:
                user = _b.sent();
                if (!user)
                    return [2 /*return*/, next(new appError_1.default("User belonging to this token does not exist", 404))];
                req.user = user;
                next();
                return [2 /*return*/];
        }
